...
sed -i "/ApplyOptionalPatch patch-%{stableversion}-redhat.patch/ a ApplyOptionalPatch 0002-camflow.patch" ~/build/kernel/kernel.spec
sed -i "/ApplyOptionalPatch patch-%{stableversion}-redhat.patch/ a ApplyOptionalPatch 0001-information-flow.patch" ~/build/kernel/kernel.spec
