...
publish:
	cd output && ls
	cd output && sh ../scripts/upload_rpm_packages.sh camflow/provenance/fedora/$(fedora-version)
	cd output && sh ../scripts/upload_deb_packages.sh camflow/provenance/ubuntu/$(ubuntu-version)
